...
public class Programmers_49993 {
    /* 스킬트리
    테스트 1 〉	통과 (0.16ms, 52.9MB)
    테스트 2 〉	통과 (0.16ms, 52.3MB)
    테스트 3 〉	통과 (0.22ms, 52.4MB)
    테스트 4 〉	통과 (0.21ms, 53.5MB)
    테스트 5 〉	통과 (0.28ms, 52.9MB)
    테스트 6 〉	통과 (0.20ms, 53.8MB)
    테스트 7 〉	통과 (0.28ms, 53.5MB)
    테스트 8 〉	통과 (0.33ms, 53.4MB)
    테스트 9 〉	통과 (0.26ms, 53.1MB)
    테스트 10 〉	통과 (0.20ms, 53.1MB)
    테스트 11 〉	통과 (0.19ms, 52.2MB)
    테스트 12 〉	통과 (0.43ms, 52.5MB)
    테스트 13 〉	통과 (0.32ms, 52.3MB)
    테스트 14 〉	통과 (0.24ms, 52.5MB)
     */
    public int solution(String skill, String[] skill_trees) {
        ...
        for(String skill_tree : skill_trees){
            ...
            int zero = 0; // 스킬(skillMap)에 없어서 바로 통과할 수 있는 스킬 개수
